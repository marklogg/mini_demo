...
# 查询alphamini包信息
info = Tool.query_py_pkg(pkg_name="alphamini", robot_id="0090")
print(f'{info}')
...
Tool.install_py_pkg(package_path="simple_socket-0.0.2-py3-none-any.whl", robot_id="0090", debug=True)
# 卸载simple_socket
Tool.uninstall_py_pkg(pkg_name="simple-socket", robot_id="0090", debug=True)
...
# 重新安装打包后的tts_demo
Tool.install_py_pkg(package_path=pkg_path, robot_id="0090")
